...
public class FtpCmd {
    ...
    private String listFile(File file) {
        ...
        if (file.isDirectory()) {
            return (String.format("drw-rw-rw- 1 ftp ftp     %s %s %s", sizeField, dateStr, file.getName())) + CmdCodeEnum.EOL;
        } else {
            return (String.format("-rw-r--r-- 1 ftp ftp     %s %s %s", sizeField, dateStr, file.getName())) + CmdCodeEnum.EOL;
        }
    }
    ...
    private String listFile2(File file) {
        ...
        if (file.isDirectory()) {
            ...
            return (String.format("type=file;modify=%s;size=%s; %s", dateStr, file.length(),
                    file.getName())) + CmdCodeEnum.EOL;
        }
    ...
    public void command_user(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
    ...
    public void command_pass(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        if (username == null) {
    ...
    public void command_syst(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
        send(CmdCodeEnum.CODE_SYSTEM_TYPE.getCode(), CmdCodeEnum.CODE_SYSTEM_TYPE.getMsg(), ctx);
    }

    public void command_clnt(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
    ...
    public void command_type(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
    ...
    public void command_noop(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
        send(CmdCodeEnum.CODE_COMMAND_SUCCESS.getCode(),
                CmdCodeEnum.CODE_COMMAND_SUCCESS.getMsg().replace("{}", "NOOP"), ctx);
    }

    public void command_port(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
    ...
    public void command_cdup(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
    ...
    public void command_list(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
        String path;
        if (st.hasMoreTokens()) {
            path = st.nextToken();
    ...
    public void command_pwd(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
    ...
    public void command_cwd(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
    ...
    public void command_retr(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
        String path = null;
        try {
        ...
        try {
            ...
            if (CmdCodeEnum.PASV.equalsIgnoreCase(usersession.getMode())) {
                ...
                while ((nread = fis.read(buf)) > 0) {
                    PasvFactory.INS.writeandflush(usersession, buf);
                }
                PasvFactory.INS.delListen(usersession);
            } else {
    ...
    public void command_mkd(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
    ...
    public void command_stor(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
        String path = null;
        try {
            path = line.substring(5);
    ...
    public void command_dele(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
        String arg = st.nextToken();
    ...
    public void command_rnfr(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
        String arg = st.nextToken();
        String filePath = resolvePath(arg);
    ...
    public void command_rnto(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
        String arg = st.nextToken();
        String filePath = resolvePath(arg);
    ...
    public void command_rmd(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
        String arg = st.nextToken();
        String dirPath = resolvePath(arg);
        File dir = new File(createNativePath(dirPath));
    ...
    public void command_quit(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession = null;
        username = null;
        password = null;
    ...
    public void command_size(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
        String path = null;
        try {
            path = line.substring(5);
    ...
    public void command_feat(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
    ...
    public void command_pasv(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException, UnknownHostException {
        ...
        String localhost = FtpBoostrap.LocalIP.replace(".", ",").concat(",").concat(param1 + "").concat(",").concat(param2 + "");
        int localport = param1 * 256 + param2;
        PasvFactory.INS.addListen(localport, usersession);

        send(CmdCodeEnum.CODE_PASV_ENABLE.getCode(), CmdCodeEnum.CODE_PASV_ENABLE.getMsg().replace("{}", localhost), ctx);
    }

    public void command_rest(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        send("501", "Syntax error.", ctx);
    }

    public void command_opts(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
        String charset = "";
        String onoff = "";
    ...
    public void command_mlst(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
        String filepath;
        if (st.hasMoreTokens()) {
    ...
    public void command_mlsd(String line, StringTokenizer st, ChannelHandlerContext ctx, Session usersession) throws CommandException {
        usersession.checklogin();
        String path;
        if (st.hasMoreTokens()) {
            path = st.nextToken();
